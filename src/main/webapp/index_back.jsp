...
<main class="cd-main-content ">
    ...
    <div class="cd-tab-filter-wrapper ">
        <div class="cd-tab-filter">
            <ul class="cd-filters">
                ...
                <li class="filter" data-filter=".color-2"><a href="#0" data-type="color-2">Chassures</a></li>
    ...
    <section class="cd-gallery ">
        <ul>
            ...
            <li class="mix color-18 check1 radio1 option1">
                <div class="demo-card-image card  mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">titre de l'imgae</div>
                    <div class="mdl-card__media"><img class="item-img" src="img/1.png"/></div>
            ...
            <li class="mix color-15 check1 radio1 option1">
                <div class="demo-card-image card  mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">titre de l'imgae</div>
                    <div class="mdl-card__media"><img class="item-img" src="img/318H.jpg"/></div>
            ...
            <li class="mix color-14 check1 radio1 option1">
                <div class="demo-card-image card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">titre de l'imgae</div>
                    <div class="mdl-card__media"><img class="item-img" src="img/Simple1.jpg"/></div>
            ...
            <li class="mix color-45 check1 radio1 option1">
                <div class="demo-card-image card  mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">titre de l'imgae</div>
                    <div class="mdl-card__media"><img class="item-img" src="img/img-1.jpg"/></div>
            ...
            <li class="mix color-19 check1 radio1 option1">
                <div class="demo-card-image card  mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">titre de l'imgae</div>
                    <div class="mdl-card__media"><img class="item-img" src="img/img-1.jpg"/></div>
            ...
            <div class="cd-filter-block clearfix">
                <div class=" input-field col s12 m6">
                    <select id="FilterSelect"  class="filter icons categories">
                        <option  disabled selected style="">Gatégorie</option>
