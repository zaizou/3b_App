    ...
    <div class="row">
        <div id="showRoot" class="col s6 container">
            <div id="showImageContainer">
                ...
                >
                    <a href="3B-Internationle_files/alger-centre.png"><img id="img1"
                                                                           src="3B-Internationle_files/alger-centre.png"></a>
                    <a href="3B-Internationle_files/3b-logo.png"><img class="magnet"
                                                                      src="3B-Internationle_files/3b-logo.png"></a>
                ...
                <div class="card-content">
                    ...
                    <ul class="collection">
                        <li class="collection-item ">
                            <div>
                                Prix :
                                <div class="secondary-content">1458 DZ</div>
                            </div>
                        </li>
                        <li class="collection-item ">
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="chip">
                                        <img src="3B-Internationle_files/99.png">
                                        Couleur 1
                                    </div>
